...
void function ShopPrices_Init()
{
    ...
    ShopPrices_AddMod("belt_fed", "Belt Fed", "Ammo is taken directly from the stockpile.", MODVALUE_EPIC)
    ...
    ShopPrices_AddMod("one_mag_or_die", "One Mag Or Die", "Mag `2halved`0. Damage `2doubled`0.", MODVALUE_EPIC)
    ...
    ShopPrices_AddMod("rampdown", "Rampdown", "Emit revo `2sesaerced`0 etar erif. Etar erif esab hgih.", MODVALUE_LEGENDARY)
    ...
    ShopPrices_AddMod("sub_mini_gun", "Submini-gun", "+50%% Fire rate & mag. -20%% damage.", MODVALUE_EPIC)
    ...
    ShopPrices_AddMod("condensed_gunpowder", "Condensed Gunpowder", "Proj. speed & damage increased. x2 recoil randomness.", MODVALUE_UNCOMMON)
    ...
    ShopPrices_AddMod("pm0", "Upgrade 1", "An upgraded, unreleased version of this tactical.", MODVALUE_RARE)
    ShopPrices_AddMod("pm1", "Upgrade 2", "An upgraded, unreleased version of this tactical.", MODVALUE_EPIC)
    ShopPrices_AddMod("pm2", "Upgrade 3", "An upgraded, unreleased version of this tactical.", MODVALUE_LEGENDARY)
    ShopPrices_AddMod("ap_rounds", "Armor Piercing Rounds", "x2 damage against titans. No crit required.", MODVALUE_RARE)
    ...
    ShopPrices_AddMod("long_charge", "Long Charge", "Increased charge time for `2triple`0 damage.", MODVALUE_UNCOMMON)
